...
func init() {
	cli := app.Command("prefund", "(protocolx) fund an owner address with utxos")
	...
	appTasks["prefund"] = func() (err error) {
		...
		/*
			...
			2. "amounts"             (string, required) A json object with addresses and amounts
			    {
			      "address":amount   (numeric or string) The protocolx address is the key, the numeric amount (can be string) in PRUX is the value
			      ,...
			    }
		*/
