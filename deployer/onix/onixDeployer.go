...
import (
	...
	"github.com/Protocol-X-Network/prux-solar/b58addr"
...
type Deployer struct {
	...
	*contract.ContractsRepository
	...
	// protocolx base58 sender address used to create a contract.
...
func (d *Deployer) CreateContract(c *contract.CompiledContract, jsonParams []byte, opts *deployer.Options) (err error) {
	// TODO: dry out similar CreateContract code from eth and protocolx deployers
	name := opts.Name
